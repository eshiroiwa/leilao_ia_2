...
section[data-testid="stSidebar"] [data-testid="stTextInput"] [data-testid="stWidgetLabel"] p,
...
/*
 * Corpo da app (stMain, não a sidebar): densidade, cartões, Base Web.
 * Toda a interface principal reutiliza o mesmo padrão da simulação.
 */
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stHorizontalBlock"] {
  row-gap: 0.12rem !important;
  column-gap: 0.28rem !important;
  align-items: start !important;
}
/* Evita grelhas 2–3 colunas a forçar scroll horizontal */
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stColumn"] {
  min-width: 0;
}
/* Cabeçalho visual da aba simulação (.sim-form-hero) */
[data-testid="stAppViewContainer"] [data-testid="stMain"] .sim-form-hero {
  display: flex;
  align-items: center;
...
[data-testid="stAppViewContainer"] [data-testid="stMain"] .sim-form-hero-tit {
  font-size: 0.88rem;
  font-weight: 700;
...
[data-testid="stAppViewContainer"] [data-testid="stMain"] .sim-form-hero-sub {
  font-size: 0.66rem;
  color: #94a3b8;
  line-height: 1.3;
  max-width: 34rem;
}
[data-testid="stAppViewContainer"] [data-testid="stMain"] p[data-testid="stCaption"] {
  font-size: 0.68rem !important;
  line-height: 1.35 !important;
  margin: 0 0 0.28rem 0 !important;
  color: #94a3b8 !important;
}
/* Toda a área principal: widgets mais próximos e largura limitada em número */
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stElementContainer"] {
  margin-bottom: 0.1rem;
}
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stNumberInput"] [data-baseweb="input"] {
  max-width: min(10rem, 100%) !important;
  min-width: 0 !important;
  box-sizing: border-box;
}
/* Simulação: zoom extra (hero com [data-sim-form-dense]) */
...
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stVerticalBlockBorderWrapper"] {
...
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stVerticalBlockBorderWrapper"] label,
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stVerticalBlockBorderWrapper"] [data-testid="stWidgetLabel"] p,
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stNumberInput"] [data-testid="stWidgetLabel"] p,
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stSelectbox"] [data-testid="stWidgetLabel"] p,
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stTextInput"] [data-testid="stWidgetLabel"] p,
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stToggle"] [data-testid="stWidgetLabel"] p {
  font-size: 0.65rem !important;
...
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stVerticalBlockBorderWrapper"] [data-baseweb="input"] {
  font-size: 0.72rem !important;
}
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stVerticalBlockBorderWrapper"] [data-testid="stWidgetLabel"] {
  margin-bottom: 0.04rem !important;
}
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stVerticalBlockBorderWrapper"] .stNumberInput input,
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stVerticalBlockBorderWrapper"] .stTextInput input {
...
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stColumn"] [data-testid="stNumberInput"] [data-baseweb="input"] {
  min-height: 1.36rem !important;
  font-size: 0.74rem !important;
  padding-top: 0.04rem !important;
  padding-bottom: 0.04rem !important;
}
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stColumn"] [data-testid="stNumberInput"] {
  margin-bottom: 0.04rem;
}
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stNumberInput"] {
  margin-bottom: 0.08rem;
}
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stSelectbox"] {
  margin-bottom: 0.08rem;
}
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stSegmentedControl"] {
  margin-bottom: 0.08rem;
}
...
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stToggle"] {
...
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stCheckbox"] label p {
  font-size: 0.7rem !important;
  line-height: 1.25 !important;
  margin: 0 !important;
}
[data-testid="stAppViewContainer"] [data-testid="stMain"] .sim-card-head {
...
[data-testid="stAppViewContainer"] [data-testid="stMain"] .sim-kpi-strip,
[data-testid="stAppViewContainer"] [data-testid="stMain"] .sim-kpi-strip strong {
  font-size: 0.56rem;
  line-height: 1.2;
  padding: 0.04rem 0 0.06rem 0;
}
[data-testid="stAppViewContainer"] [data-testid="stMain"] .sim-praca-ref {
  font-size: 0.62rem;
  margin: 0 0 0.1rem 0;
}
/* Botões no bloco de simulação */
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stButton"] {
  margin-bottom: 0.08rem;
}
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stButton"] > button {
  min-height: 1.75rem;
  padding-top: 0.12rem;
...
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stNumberInput"] [data-baseweb="input"],
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stTextInput"] [data-baseweb="input"] {
  border-radius: 8px !important;
  background: linear-gradient(180deg, rgba(20, 28, 44, 0.92) 0%, rgba(12, 18, 32, 0.88) 100%) !important;
  border: 1px solid rgba(110, 231, 183, 0.22) !important;
  color: #e8edf3 !important;
...
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stNumberInput"] [data-baseweb="input"]:hover,
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stTextInput"] [data-baseweb="input"]:hover {
  border-color: rgba(110, 231, 183, 0.38) !important;
}
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stNumberInput"] [data-baseweb="input"]:focus,
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stTextInput"] [data-baseweb="input"]:focus {
  border-color: rgba(45, 212, 191, 0.5) !important;
  box-shadow: 0 0 0 1px rgba(45, 212, 191, 0.22) !important;
}
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stSelectbox"] [data-baseweb="select"] > div {
  border-radius: 8px !important;
  min-height: 1.42rem !important;
  background: linear-gradient(180deg, rgba(20, 28, 44, 0.92) 0%, rgba(12, 18, 32, 0.88) 100%) !important;
  border: 1px solid rgba(110, 231, 183, 0.22) !important;
...
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stSegmentedControl"] [role="radiogroup"] {
...
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stSegmentedControl"] [role="radio"] {
...
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stSegmentedControl"] [role="radio"][aria-checked="true"] {
...
[data-testid="stAppViewContainer"] [data-testid="stMain"] [data-testid="stSegmentedControl"] button {
  border-radius: 6px !important;
  font-weight: 600 !important;
  font-size: 0.7rem !important;
  padding: 0.2rem 0.45rem !important;
...
[data-testid="stAppViewContainer"] [data-testid="stMain"] iframe[title^="streamlit"] {
  border-radius: 6px;
}
.stButton > button {
  font-family: "DM Sans", system-ui, sans-serif !important;
