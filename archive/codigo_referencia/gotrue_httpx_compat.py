"""
gotrue (supabase-py 2.3.x) chama httpx.Client(..., proxy=...), mas httpx 0.24+ só aceita proxies=.

Ao importar gotrue, vários submódulos guardam a referência antiga a SyncClient/AsyncClient;
reatribuímos em todos os módulos gotrue já carregados em sys.modules.
"""
